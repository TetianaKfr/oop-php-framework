...
<a href="<?= HREF_ROOT ?>admin/posts/create" class="btn btn-success my-3">Modifier les tags</a>
<a href="<?= HREF_ROOT ?>admin/posts/create" class="btn btn-success my-3">Ajouter media</a>
